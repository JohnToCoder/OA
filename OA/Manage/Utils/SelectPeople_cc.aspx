<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectPeople_cc.aspx.cs" Inherits="WC.WebUI.Manage.Utils.SelectPeople_cc" %>
...
{
   var name_txt = window.parent.document.getElementById("namelist_cc");
   var user_txt = window.parent.document.getElementById("userlist_cc");
...
function initdata()
{
   var tmp = window.parent.document.getElementById("userlist_cc");
   var objs = document.getElementsByTagName("input"); 
