<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRM_Contact_List.aspx.cs" Inherits="WC.WebUI.Manage.CRM.CRM_Contact_List" %>
...
function depView(ud)
{
	...
	diag.Height = 385;
	diag.Title = "客户接触详情";
	diag.URL = '/manage/CRM/CRM_Contact_View.aspx?ctid='+ud+'&cid=<%=c %>';
	diag.show();
}
</script> 
</head>
 ...
 <asp:Repeater runat=server ID=rpt><ItemTemplate>
	<tr>
		...
		<td class="vtip" style="font-weight:bold;" title=<%# Eval("ContactAim") %> onclick='depView(<%#Eval("id") %>)'>
			<a  href='javascript:;' ><%# WC.Tool.Utils.GetSubString2(Eval("ContactAim")+"",26,"..") %></a>
		</td>	
		<td >
		...
		<td class="manage">
		    <a onclick='depView(<%#Eval("id") %>)' href='javascript:;' class="show">查看</a>
