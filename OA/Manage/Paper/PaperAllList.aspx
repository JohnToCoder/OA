<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaperAllList.aspx.cs" Inherits="WC.WebUI.Manage.Paper.PaperAllList" %>
<%@ Register Src="~/Controls/Page.ascx" TagName="Page" TagPrefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8"/><title>所有档案列表</title>
...
<script type="text/javascript">
    function depView(ud) {
        ...
        diag.Height = 375;
        diag.Title = "查看电子档案";
        diag.URL = '/manage/Paper/PaperView.aspx?pid=' + ud;
        diag.show();
    }
</script>
</head>
...
<div id="interface_inside">
  <div id="interface_quick">
    <div class="interface_quick_left">您现在的操作 >> 电子档案 >> 所有档案列表</div>
...
<table class="table subsubmenu">
  <thead>
	<tr>
	  <td>
<a href="PaperAllList.aspx" >所有档案列表</a>
	  </td>
...
<tr>
	...
	<INPUT runat=server id=StartTime name=StartTime type=text class="Wdate" dataType="Require" msg="起始时间不能为空"  readonly onclick="WdatePicker({dateFmt:'yyyyMMdd'})"> 到
<INPUT runat=server id=EndTime name=EndTime type=text class="Wdate" dataType="Require" msg="结束时间不能为空"  readonly onclick="WdatePicker({dateFmt:'yyyyMMdd'})">  
	</td>
</tr>
...
<thead>
 ...
 <asp:Repeater runat=server ID=rpt ><ItemTemplate>
	<tr>
		...
		[<%# GetTypeName(Eval("TypeID")) %>] &nbsp; <a href='javascript:;' onclick='depView(<%#Eval("id") %>)' ><%#Eval("PaperName")%></a>
		</td>	
		<td>
		<%#Eval("PaperSymbol")%>
		</td>
	    ...
	    <td class="manage">
        <a href=PaperManage.aspx?pid=<%#Eval("id") %> >编辑</a>
	    <a href='javascript:;' onclick='depView(<%#Eval("id") %>)' class="show">查看</a>
        <asp:LinkButton runat=server ID=b1 OnClick=Del_Btn OnClientClick="javascript:return confirm('确实要删除该档案吗？')">删除</asp:LinkButton>
		</td>	
	</tr>
