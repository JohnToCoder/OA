<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_List.aspx.cs" Inherits="WC.WebUI.Manage.Sys.User_List" %>
...
<script type="text/javascript">
    function personView(ud) {
        ...
        diag.Height = 465;
        diag.Title = "个人资料预览";
        diag.URL = '/manage/Sys/User_View.aspx?type=1&uid=' + ud;
        diag.show();
    }
</script> 
</head>
...
<thead>
 ...
 <asp:Repeater runat=server ID=rpt><ItemTemplate>
	<tr>
		...
		<td class="manage">
		    <a href='javascript:;' onclick='personView(<%#Eval("id")%>)' class="show">查看</a>
