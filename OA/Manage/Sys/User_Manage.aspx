<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_Manage.aspx.cs" Inherits="WC.WebUI.Manage.Sys.User_Manage" %>
...
<table class="table subsubmenu">
  <thead>
	<tr>
	  <td>
<a href="/manage/sys/User_Manage.aspx" class="selected">新增用户</a>
	  </td>
...
<tr >
	...
	<td>
	<span class="note">员工的移动电话 (移动电话 将出现在 登陆用户的通讯录中)</span>
<INPUT runat=server
