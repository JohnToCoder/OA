<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gov_Recipient.aspx.cs" Inherits="WC.WebUI.Manage.Gov.Gov_Recipient" %>
<%@ Register Src="~/Controls/Page.ascx" TagName="Page" TagPrefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8"/><title>我的公文签收列表</title>
...
<div id="interface_inside">
  <div id="interface_quick">
    <div class="interface_quick_left">您现在的操作 >> 我的公文 >> 收文管理 <%=flow_list %></div>
...
<thead>
 ...
 <asp:Repeater runat=server ID=rpt ><ItemTemplate>
	<tr >
		...
		<a href=Gov_Recipient_View.aspx?fl=<%#Eval("id") %> ><%#Eval("Flow_Name")%></a>
		</td>	
		<td>
	    ...
	    <asp:Label runat=server ID=lb1 Text=<%#Eval("CurrentStepUserList") %> Visible=false></asp:Label>
            <a href=Gov_Recipient_View.aspx?fl=<%#Eval("id") %> >查看/签收</a>
