<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaperView.aspx.cs" Inherits="WC.WebUI.Manage.Paper.PaperView" %>
...
<tr>
	<td>&nbsp;</td>
	<td colspan="2" class="manage"><a href="javascript:parentDialog.close()">关闭本页</a>
	</td>
</tr>
</table>
