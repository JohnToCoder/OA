<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Flow_ModelFileManage.aspx.cs" Inherits="WC.WebUI.Manage.Flow.Flow_ModelFileManage" %>
...
<tr >
	...
	<span class="note">支持HTML自定义编辑丰富的Web表单. (编辑器大小可拖拉自如) </span>
		...
		<textarea id="DocBody" style="width:720px;height:665px;visibility:hidden;" 
