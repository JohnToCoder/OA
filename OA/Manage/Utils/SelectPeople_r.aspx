<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectPeople_r.aspx.cs" Inherits="WC.WebUI.Manage.Utils.SelectPeople_r" %>
...
{
    var obj = <%=bj %>;
    var name_txt = window.parent.document.getElementById("namelist"+obj);
    var user_txt = window.parent.document.getElementById("userlist"+obj);
...
{
    var obj = <%=bj %>;
   var tmp = window.parent.document.getElementById("userlist"+obj);
   var objs = document.getElementsByTagName("input"); 
