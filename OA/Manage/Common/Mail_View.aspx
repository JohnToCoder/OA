<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mail_View.aspx.cs" Inherits="WC.WebUI.Manage.Common.Mail_View" %>
...
<table class="table">
	...
	<tr>
        ...
        <div runat=server id=bodys style="min-height:100px;_height:100px;margin:10px 10px 1px 1px; border:1px solid #E3E197; padding:10px 10px 10px 10px; background-color: #FFFFDD;"></div>
				<%=this.fjs %>
		</td>
	</tr>	
