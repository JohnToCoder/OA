<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkAttendList.aspx.cs" Inherits="WC.WebUI.Manage.Attend.WorkAttendList" %>
...
<script type="text/javascript">
    function depView(id) {
        ...
        diag.Height = 300;
        diag.Title = "查看考勤信息";
        diag.URL = '/manage/Attend/WorkAttendView.aspx?wid=' + id;
        diag.show();
    }
</script> 
</head>
