<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Task_View.aspx.cs" Inherits="WC.WebUI.Manage.Tasks.Task_View" EnableViewState="false" %>
...
<script type="text/javascript">
    function depView(ud) {
        ...
        diag.Height = 485;
        diag.Title = "任务执行详情";
        diag.URL = '/manage/Tasks/FeedBack_View.aspx?tuid=' + ud;
        diag.show();
    }
</script>
...
<a href='javascript:;' onclick='depView(<%#Eval("id") %>)' class="show">查看详情</a>
</asp:Panel>
</tr>
...
<tr>
	...
	<textarea id="Bodys" name="Bodys" style="width:75%;height:170px;visibility:hidden;" runat="server" enableviewstate=false></textarea>
	</td>
</tr>
<tr>
	<th style="width:10px;"></th>
