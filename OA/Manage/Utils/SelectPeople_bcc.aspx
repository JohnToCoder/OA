<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectPeople_bcc.aspx.cs" Inherits="WC.WebUI.Manage.Utils.SelectPeople_bcc" %>
...
{
    var name_txt = window.parent.document.getElementById("namelist_bcc");
    var user_txt = window.parent.document.getElementById("userlist_bcc");
...
function initdata()
{
   var tmp = window.parent.document.getElementById("userlist_bcc");
   var objs = document.getElementsByTagName("input"); 
...
<body style="overflow:hidden; overflow-x:hidden;overflow-y:hidden;" onload='initdata()'>
    ...
    <div style="margin-left:10px; text-align:left; margin-top:5px;">
        ...
        &nbsp;&nbsp;
     <span >
         <a href=javascript:; onclick=clearAll() >清除已选</a>
    &nbsp;&nbsp;<a href=javascript:; onclick=selectAll() >全体人员</a>
    &nbsp;&nbsp;<input type="text" name="keyword"  maxlength=10  id="Text1" size=8 />
