<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_OnLine.aspx.cs" Inherits="WC.WebUI.Manage.Common.User_OnLine" %>
...
<thead>
 ...
 <asp:Repeater runat=server ID=rpt_person EnableViewState=false><ItemTemplate>
	<tr>
		...
		<td class="manage">
		<a href='javascript:;' onclick='personView(<%#Eval("id")%>)'>查看资料</a>
