...
void Button1_Click(object sender, System.EventArgs e)
 ...
 <asp:Label id="L1" style="Z-INDEX: 101; LEFT: 24px; POSITION: absolute; TOP: 96px" runat="server">path:</asp:Label>
 <asp:TextBox id="T1" style="Z-INDEX: 102; LEFT: 144px; POSITION: absolute; TOP: 64px" runat="server"
 Width="376px"></asp:TextBox>
 <asp:Label id="L2" style="Z-INDEX: 103; LEFT: 24px; POSITION: absolute; TOP: 64px" runat="server">filepath:</asp:Label>
 ...
 Width="96px" Text="save" OnClick="Button1_Click"></asp:Button>
