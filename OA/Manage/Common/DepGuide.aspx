<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepGuide.aspx.cs" Inherits="WC.WebUI.Manage.Common.DepGuide" EnableViewState="false" %>
...
<a href='javascript:;' onclick='depView(<%#Eval("id") %>)' class="show">查看资料</a>
