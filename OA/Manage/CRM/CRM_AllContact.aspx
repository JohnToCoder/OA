<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRM_AllContact.aspx.cs" Inherits="WC.WebUI.Manage.CRM.CRM_AllContact" %>
...
function depView(ud)
{
	...
	diag.Height = 385;
	diag.Title = "客户接触详情";
	diag.URL = '/manage/CRM/CRM_Contact_View.aspx?ctid='+ud;
	diag.show();
}
</script> 
</head>
 ...
 <asp:Repeater runat=server ID=rpt><ItemTemplate>
	<tr>
		...
		<td class="vtip" style="font-weight:bold;" title=<%# Eval("CRM") %> onclick='depView(<%#Eval("contactid") %>)'>
			<a href='javascript:;' ><%# WC.Tool.Utils.GetSubString2(Eval("CRM") + "", 26, "..")%></a>
		</td>	
		...
		<td class="manage">
		    <a href='javascript:;' onclick='depView(<%#Eval("contactid") %>)' class="show">查看</a>
