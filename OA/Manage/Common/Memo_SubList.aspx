<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Memo_SubList.aspx.cs" Inherits="WC.WebUI.Manage.Common.Memo_SubList" %>
...
function subView(uid,st)
{
	...
	diag.Width = 800;
	diag.Height = 420;
	diag.Title = '<%=uname %>'+' 的工作日程';
	diag.URL = '/manage/common/Memo_SubView.aspx?uid='+uid+'&st='+st;
	diag.show();
}
...
<thead>
 ...
 <asp:Repeater runat=server ID=rpt><ItemTemplate>
	<tr>
        ...
        <td class="manage">
 			<a href='javascript:;' onclick='subView(<%=Request.QueryString["uid"] %>,<%#Eval("s") %>)' class='show'>查看当天日程</a>
        </td>
	</tr>
